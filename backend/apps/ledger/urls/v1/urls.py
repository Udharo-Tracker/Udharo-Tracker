...
urlpatterns = [
    ...
    path(
        "customers/<uuid:customer_id>/credit-score/",
        CustomerCreditScoreView.as_view(),
        name="customer-credit-score",
    ),
    path(
        "customers/<uuid:customer_id>/credit-score/history/",
        CustomerCreditScoreHistoryView.as_view(),
        name="customer-credit-score-history",
    ),
